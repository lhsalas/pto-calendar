    ...
    >
      <div className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-lg">
        <div className="mb-4 flex items-center justify-between">
          <h2 id="pto-view-title" className="text-lg font-semibold text-slate-900">
            PTO details
          </h2>
          <button
            type="button"
        ...
        <dl className="mb-4 space-y-2 text-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <dd className="font-medium text-slate-900">{formatRange(pto)}</dd>
          </div>
          <div className="flex items-center justify-between">
            <dt className="text-slate-500">Day part</dt>
            <dd className="font-medium text-slate-900">{dayPartLabel(pto.dayPart)}</dd>
          </div>
          <div className="flex items-start justify-between gap-3">
            <dt className="text-slate-500">Note</dt>
            <dd className="max-w-xs text-right text-slate-900">
              {fullPto.note ?? <span className="text-slate-400">(no note)</span>}
          ...
          <div className="mb-3 rounded border border-red-200 bg-red-50 p-3 text-sm text-red-700">
            ...
            <div className="flex justify-end gap-2">
              <button
                ...
                disabled={busy}
                className="rounded border border-slate-300 bg-white px-3 py-1.5 text-sm hover:bg-slate-100 disabled:opacity-60"
              >
                Cancel
              </button>
              <button
